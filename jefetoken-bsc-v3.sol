...
// File: stephens_no_antibot_no_unlock-final.sol
...
contract JEFE is Context, IBEP20, Ownable {
    ...
    //vault address 
    address public _vaultWalletAddress = 0x000000000000000000000000000000000000dEaD;
   ...
   //total supply and token general setup
    ...
    uint256 public _maxTxAmount = 3000000 * 10**1 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 5000000 * 10**1 * 10**9;
